...
features_files = ['train_' + features_name + '_features.csv', 'val_' + features_name + '_features.csv',
                  'test_' + features_name + '_features.csv']
features_counts_files = ['train_' + features_name + '_counts.txt', 'val_' + features_name + '_counts.txt',
                         'test_' + features_name + '_counts.txt']

# Outputs
out_features_name = 'C3D_fc8_ImageNet'
out_features = ['train_' + out_features_name + '.csv', 'val_' + out_features_name + '.csv',
                'test_' + out_features_name + '.csv']
out_features_counts = ['train_' + out_features_name + '_counts.txt', 'val_' + out_features_name + '_counts.txt',
